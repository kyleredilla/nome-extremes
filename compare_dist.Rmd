...
mk_ncfns <- function() {
  suffix <- c("1979-1982", "1983-1986", "1987-1990", "1991-1994",
              ...
              "2011-2014", "2015-2018")
  paste0("F:/raw_data/Nome_Mets/ERA5_sf_sd_ta_Nome_sector_", suffix, ".nc")
}
...
get_coords <- function(dists) {
  ...
  nc <- nc_open("F:/raw_data/Nome_Mets/ERA5_sf_sd_ta_Nome_sector_1979-1982.nc")
...
plot_dists <- function() {
  ...
  sf_path <- "F:/raw_data/Nome_Mets/ERA5_land_sea_mask_Nome_sector.nc"
  sf <- nc_open(sf_path)
